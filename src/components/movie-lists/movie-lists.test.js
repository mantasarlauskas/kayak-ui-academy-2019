...
describe('Lists component: ', () => {
  ...
  it('should render one list element', () => {
    wrapper = getMountedElement(mockStore(initialState));
    expect(wrapper.find('li').length).toEqual(1);
  });

  it('should render zero list elements', () => {
    wrapper = getMountedElement(mockStore({ ...initialState, lists: { array: [] } }));
